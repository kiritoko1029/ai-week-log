...
contextBridge.exposeInMainWorld('weeklog', {
  ...
  memory: {
    ...
    downloadModel: () => ipcRenderer.invoke('memory:downloadModel'),
    openModelFolder: () => ipcRenderer.invoke('memory:openModelFolder'),
    clearModel: () => ipcRenderer.invoke('memory:clearModel'),
